        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                'flex h-auto min-h-10 items-center justify-between rounded-md bg-inherit px-3 py-2 hover:bg-inherit [&_svg]:pointer-events-auto',
            ...
            >
              {selectedValues.length > 0 ? (
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm p-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                                  'h-3 w-3',
                ...
                <div className="mx-auto flex w-full items-center justify-between">
                  <span className="text-sm leading-tight font-medium text-zinc-900 opacity-50">
                    {placeholder}
                  </span>
          ...
          <PopoverContent
            ...
            className={cn(
              'w-auto border-none p-0 outline-none',
              getPopoverAnimationClass(),
              screenSize === 'mobile' && 'w-[85vw] max-w-[280px]',
              screenSize === 'tablet' && 'w-[70vw] max-w-[259px]',
              screenSize === 'desktop' && 'min-w-[259px]',
              popoverClassName,
            )}
            style={{
              animationDuration: `${animationConfig?.duration || animation}s`,
